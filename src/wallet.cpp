...
// Dekado: total coins staked (non-spendable until maturity)
...
// Dekado: get current stake weight
...
// Dekado: check 'spent' consistency between wallet and txindex
// Dekado: fix wallet spent state according to txindex
...
// Dekado: disable transaction (only for coinstake)
